...
5. **Start Scanning:** Open the **🎥 Live Scanner** tab and allow camera permissions. The system will autonomously scan and verify faces.
![Live Scanner](<imgs/Screenshot 2026-03-31 150902.png>)
7. **Export Logs:** Go to the **📊 Access Logs** tab to view attendance or download the data as a `.csv` file for payroll/HR integration.
